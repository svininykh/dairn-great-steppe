...
Он не изменяет ни формат, ни пилот.
...
| Структурированные герои имеют стабильные уникальные ID | MATCH | `aibike` и `karashash` в `book.yaml`; дубликатов нет. |
...
исправлялось. Format redesign: **NOT PERFORMED**.
