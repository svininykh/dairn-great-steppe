# Визуальная система DAIRN

Это единая точка входа для будущего иллюстратора. Она не заменяет руководство
ветви и не принимает художественное решение вместо человека.

## Маршрут

```text
VISUAL → UNIVERSE → HISTORICAL (если нужна материальная проверка) →
конкретная ветвь → ILLUSTRATION PRODUCTION → human review
```
...
| Задача | Руководство |
| --- | --- |
| Книга игрока, приключение, исследование, путешествие, тихая опасность или возможный путь | [DAIRN-TABLETOP-ILLUSTRATION-GUIDE.md](DAIRN-TABLETOP-ILLUSTRATION-GUIDE.md) |
